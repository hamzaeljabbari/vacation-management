                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="example1">
                                    ...
                                    <tbody>
                                       <?php
                                            $user=$_SESSION['email'];
                                            $select = "select * from conge where user='$user' order by id desc ";
                                            ...
                                            <td  >  <?php echo $data_group['commantaire']; ?> </td> 
                                            <td align="left">
                                                <?php if($data_group['etat']==0) { echo 'En cours de traitement'; } ?>
                                                <?php if($data_group['etat']==1) { echo 'Validé'; } ?>
                                                <?php if($data_group['etat']==2) { echo 'Refusé'; } ?>
                                            </td> 
                                   </tr>
