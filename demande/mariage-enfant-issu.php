...
<p dir="ltr">
    Objet : réponse à votre demande d’absence exceptionnelle (Mariage d'un
    enfant issu d'un précédent mariage du conjoint du salarié)
</p>

<p dir="ltr">
   A la suite de votre courrier , vous avez sollicité une autorisation exceptionnelle
      d'absence de <?php echo $_GET['nbr']; ?> jours. à l’occasion du mariage de votre
    enfant.
</p>
<br/>
<p dir="ltr">
